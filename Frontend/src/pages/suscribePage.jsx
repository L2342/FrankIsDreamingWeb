...
export default function DreamNewsletter() {
  ...
  useEffect(() => {
    ...
    script.src =
      'https://www.google.com/recaptcha/api.js?render=6LcncN0rAAAAAF5zBo0c6cDrrDiwM6nRukFMudje&hl=es';
    script.async = true;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const token = await window.grecaptcha.execute(
        '6LcncN0rAAAAAF5zBo0c6cDrrDiwM6nRukFMudje',
        { action: 'submit' }
      );

      // 2. Preparar datos como espera Brevo
      const formData = new FormData();
      formData.append('EMAIL', email);
      formData.append('locale', 'es');
      formData.append('email_address_check', '');
      formData.append('g-recaptcha-response', token); // 👈 obligatorio
      ...
      await fetch(
        'https://5d30eb87.sibforms.com/serve/MUIFAEeaXgXoF2AJc-achIEUiWwJHPlps57ZpBhNkoDU5_qK5xb3MqPaTKwWG1ie5WGhGlBPf2mKH10sK1k4nvJ1ibdJMkSTE5UusFLSnFg-4uf0l7m7oI6dyqAlztJ9h693Zm94LCnu56V4mxdrnyah1_PXBvZdBGK5r7e0TxQvWoh3Q9RS9ViJw61FhvSm8J33e3lPYLWVkvG2',
        {
          method: 'POST',
          body: formData,
          mode: 'no-cors', // no podrás leer respuesta, pero Brevo sí lo recibe
        }
      );
      ...
      <div className="relative z-10 w-full px-4 lg:px-8 flex justify-end items-center min-h-screen">
        <div className="w-full max-w-xl lg:mr-12 xl:mr-24">
          <div className="relative bg-slate-900/30 backdrop-blur-lg rounded-3xl shadow-2xl border border-purple-500/30 p-8 lg:p-12">
            ...
            {step === 1 && (
              <div className="text-center space-y-6 animate-fade-in">
                ...
                <h1
                  className="text-4xl lg:text-5xl text-purple-100 mb-4 leading-tight"
                  style={{ fontFamily: "'Henny Penny', cursive" }}
                >
                  Adéntrate en el Sueño
                </h1>
                <p
                  className="text-base lg:text-lg text-purple-100/90 leading-relaxed"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  El mundo de <span className="italic">Frank Is Dreaming</span>{' '}
                  guarda mensajes que no todos pueden ver.
                </p>
                <p
                  className="text-base lg:text-lg text-purple-100/90 leading-relaxed"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Suscríbete y recibe señales, visiones anticipadas y fragmentos
            ...
            {step === 2 && (
              <div className="text-center space-y-6 animate-fade-in">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Solo quienes comparten su dirección podrán recibir los
                  susurros del otro lado. Escribe tu correo… y mantente conectado
                  con lo que se oculta entre la vigilia y el sueño.
                </p>
                <div className="mt-8 space-y-6 pt-4">
                  <div>
                    ...
                    {error && (
                      <div
                        className="mt-3 text-red-400 text-sm text-left px-4"
                        style={{ fontFamily: "'Playfair Display', serif" }}
                      >
                        {error}
                      </div>
                    ...
                    <div
                      className="text-xs text-purple-300/50 mt-3 text-left px-4"
                      style={{ fontFamily: "'Playfair Display', serif" }}
                    >
                      Introduce tu dirección de e-mail para suscribirte. Ej.:
                      abc@xyz.com
                    </div>
                  </div>
                  <button
            ...
            {step === 3 && (
              <div className="text-center space-y-6 animate-fade-in">
                ...
                <p
                  ...
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Revisa tu bandeja de entrada. La primera señal ya está en
                  camino.
                </p>
                <p
                  className="text-base lg:text-lg text-purple-100/90 leading-relaxed"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  A partir de ahora, las puertas del mundo onírico permanecerán
                  abiertas para ti.
                </p>
          ...
          <div className="text-center mt-6">
            <h2
              className="text-xl lg:text-2xl text-purple-300/60"
              style={{ fontFamily: "'Henny Penny', cursive" }}
            >
              Frank Is Dreaming
            </h2>
